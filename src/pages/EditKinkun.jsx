...
export default function EditKinkun() {
  ...
  const handleSaveUpdateClick = async (e) => {
    ...
    successAlert('บันทึกการกินเเก้ไขเรียบร้อยแล้ว')    
  ...
  return (
    <div>
      <div className="w-10/12 mx-auto border-gray-300 p-6 shadow-md mt-20 rounded-lg">
        ...
        <img src={restaurant} alt="กินกัน" className="block mx-auto w-20 mt-5 mb-5" />
        ...
        <form onSubmit={handleSaveUpdateClick}>
            ...
            <div className="mt-3">
              ...
              <div className="mt-3">
                {
                  foodName && <img src={restaurant} alt="รูปกิน" className="w-30" />
                }
              </div>
            </div>  
